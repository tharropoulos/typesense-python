...
Classes:
    - Synonyms: Handles async operations related to synonyms within a collection.

Methods:
    - __init__: Initializes the Synonyms object.
    - __getitem__: Retrieves or creates an Synonym object for a given synonym_id.
...
@deprecated("SyncSynonyms is deprecated on v30+. Use client.synonym_sets instead.")
class Synonyms:
    """
    ...
    def __getitem__(self, synonym_id: str) -> Synonym:
        """
        Get or create an Synonym object for a given synonym_id.
