...
Classes:
    - AnalyticsRuleV1: Handles async operations related to a specific analytics rule.
...
@deprecated(
    "SyncAnalyticsRuleV1 is deprecated on v30+. Use client.analytics.rules[rule_id] instead."
)
