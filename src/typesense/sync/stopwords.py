...
Classes:
    - Stopwords: Handles async operations related to stopwords and stopword sets.

Methods:
    - __init__: Initializes the Stopwords object.
    - __getitem__: Retrieves or creates an StopwordsSet object for a given stopwords_set_id.
...
class Stopwords:
    ...
    def __getitem__(self, stopwords_set_id: str) -> StopwordsSet:
        """
        Get or create an StopwordsSet object for a given stopwords_set_id.
