...
Classes:
    - AnalyticsV1: Handles async operations related to analytics, including access to analytics rules.
...
from .analytics_rules_v1 import AnalyticsRulesV1
from .api_call import ApiCall


@deprecated("SyncAnalyticsV1 is deprecated on v30+. Use client.analytics instead.")
