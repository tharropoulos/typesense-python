...
Classes:
    - StemmingDictionaries: Handles async operations related to stemming dictionaries.

Methods:
    - __init__: Initializes the StemmingDictionaries object.
    - __getitem__: Retrieves or creates an StemmingDictionary object for a given dictionary_id.
...
from .stemming_dictionary import StemmingDictionary
...
class StemmingDictionaries:
    ...
    def __getitem__(self, dictionary_id: str) -> StemmingDictionary:
        """
        Get or create an StemmingDictionary object for a given dictionary_id.
