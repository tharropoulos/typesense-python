...
It contains the AsyncDocuments class, which allows for creating, updating, importing, exporting,
searching, and deleting documents asynchronously.

Classes:
    AsyncDocuments: Manages async operations on documents in the Typesense API.

Dependencies:
    - typesense.async_api_call: Provides the AsyncApiCall class for making async API requests.
    - typesense.async_document: Provides the AsyncDocument class for individual document operations.
...
class AsyncDocuments(typing.Generic[TDoc]):
    ...
    Attributes:
        ...
        documents (Dict[str, AsyncDocument[TDoc]]): A dictionary of AsyncDocument instances.
    """
    ...
    def __init__(self, api_call: AsyncApiCall, collection_name: str) -> None:
        """
        Initialize the AsyncDocuments instance.
        ...
        self.documents: typing.Dict[str, AsyncDocument[TDoc]] = {}

    def __getitem__(self, document_id: str) -> AsyncDocument[TDoc]:
        """
        Get or create an AsyncDocument instance for a given document ID.

        Args:
            document_id (str): The ID of the document.

        Returns:
            AsyncDocument[TDoc]: The AsyncDocument instance for the specified document ID.
        """
    ...
    async def export(
        ...
        """
        api_response: str = await self.api_call.get(
    ...
    async def delete(
        ...
        """
        response: DeleteResponse = await self.api_call.delete(
            self._endpoint_path(),
